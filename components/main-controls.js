  ...
  connectedCallback() {
    this.innerHTML = `
      ...
      <div class="controlContainer">
        ...
        <button id="languageDa" class="languagePick" type="button" lang="da"><span class='underline'>D</span>ansk</button>
        <button id="languageEng" class="languagePick" type="button" lang="en"><span class='underline'>E</span>nglish</button>
      </div>
    `;
  }
}
